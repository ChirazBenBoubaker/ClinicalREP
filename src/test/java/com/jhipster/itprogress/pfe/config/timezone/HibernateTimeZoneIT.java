package com.jhipster.itprogress.pfe.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.jhipster.itprogress.pfe.IntegrationTest;
import com.jhipster.itprogress.pfe.repository.timezone.DateTimeWrapper;
import com.jhipster.itprogress.pfe.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM itp_date_time_wrapper where id=%d", fieldName, id);
    }
