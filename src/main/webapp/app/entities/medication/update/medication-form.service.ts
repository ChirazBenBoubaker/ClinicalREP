...
type MedicationFormGroupContent = {
  ...
  medicationText: FormControl<IMedication['medicationText']>;
  date: FormControl<IMedication['date']>;
  patientUID: FormControl<IMedication['patientUID']>;
};
...
export class MedicationFormService {
  createMedicationFormGroup(medication: MedicationFormGroupInput = { id: null }): MedicationFormGroup {
    ...
    return new FormGroup<MedicationFormGroupContent>({
      ...
      medicationText: new FormControl(medicationRawValue.medicationText),
      date: new FormControl(medicationRawValue.date),
      patientUID: new FormControl(medicationRawValue.patientUID),
    });
  }
