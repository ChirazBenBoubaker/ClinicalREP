      ...
      return (
        ...
        (e.addClass = function (t) {
          return this.selector.classList
            ...
            : (-1 == this.selector.className.split(' ').indexOf(t) && (this.selector.className += ' ' + t), this);
        }),
        (e.append = function (t) {
      ...
      return (
        ...
        (i.updateStyle = function () {
          ...
          f.merge(t, this.style.initial),
            ...
            this.isSelected && (f.merge(t, this.style.selected), this.isHovered && f.merge(t, this.style.selectedHover)),
            this.set(t);
        }),
        e
      );
    ...
    S = (function (t) {
      ...
      return (
        ...
        (e.prototype.applyAttr = function (e, i) {
          var s;
          'image' === e
            ? (f.isObj(i) ? ((s = i.url), (this.offset = i.offset || [0, 0])) : ((s = i), (this.offset = [0, 0])),
  ...
  var T = Object.freeze({
      ...
      handleElementEvents: function () {
        ...
        this.container.delegate('.jvm-element', 'mouseover mouseout', function (e) {
          ...
          'mouseover' === e.type
            ? e.defaultPrevented ||
              (i.element.hover(!0), s && (t.tooltip.text(i.tooltipText), t.tooltip.show(), t.emit(i.event, [t.tooltip, i.code])))
            ...
            ? ((o = this.scale),
              ...
              (n = setInterval(function () {
                (g += 1),
                  ...
                  m.applyTransform(),
                  g == v && (clearInterval(n), m.emit('viewport:changed', [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
    ...
    z = (function () {
      function t(e) {
        if ((void 0 === e && (e = {}), (this.params = f.mergeDeeply(t.defaults, e)), !t.maps[this.params.map]))
      ...
      return (
        (e.init = function (t) {
          ...
          (this.container = f.$(t).addClass('jvm-container')),
            ...
            e.series &&
              (this.container
                .append((this.legendHorizontal = f.createElement('div', 'jvm-series-container jvm-series-h')))
                .append((this.legendVertical = f.createElement('div', 'jvm-series-container jvm-series-v'))),
              this.createSeries()),
        ...
        (e.reset = function () {
          ...
          this.legendHorizontal && (f.removeElement(this.legendHorizontal), (this.legendHorizontal = null)),
            this.legendVertical && (f.removeElement(this.legendVertical), (this.legendVertical = null)),
